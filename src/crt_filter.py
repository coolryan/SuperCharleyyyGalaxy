...
# Store our screen dimension & title in a convenient place
SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_TITLE = 800, 1100, "ShaderToy Demo"
...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        map = arcade.Sprite("src/images/Pac-man.png", center_x=width / 2, center_y=height / 2)
        map.scale = width / map.width
        self.sprite_list.append(map)

        # Slice out some textures from the sprite sheet
        spritesheet = arcade.load_spritesheet("src/images/pac_man_sprite_sheet.png")
