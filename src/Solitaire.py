...
# how big is is the mat we'll place the card on?
MAT_PERCENT_OVERSIZE = 1.25
MAT_HEIGHT = int(CARD_HEIGHT * MAT_PERCENT_OVERSIZE)
MAT_WIDTH = int(CARD_WIDTH * MAT_PERCENT_OVERSIZE)

# How much space do we leave as a gap between the mats?
# Done as percent of the mat size.
...
# If we fan out crads stacked on each other, how far apart to fan them?
CARD_VERTICAL_OFFSET = CARD_HEIGHT * CARD_SCALE * 0.3

# Constant that represent "what pile is what" for the game
PILE_COUNT, BOTTOM_FACE_DOWN_PILE, BOTTOM_FACE_UP_PILE = 13, 0, 1
PLAY_PILE_1, PLAY_PILE_2, PLAY_PILE_3, PLAY_PILE_4 = 2, 3, 4, 5
PLAY_PILE_5, PLAY_PILE_6, PLAY_PILE_7 = 6, 7, 8
TOP_PILE_1, TOP_PILE_2, TOP_PILE_3, TOP_PILE_4 = 9, 10, 11, 12
        ...
        if len(cards) > 0:
            ...
            if pile_index == BOTTOM_FACE_DOWN_PILE:
                ...
                for i in range(3):
                    ...
                    # Remove card position to bottom-right face up pile
            ...
            if len(mats) > 0:
                ...
                if (
                    mat_index == BOTTOM_FACE_UP_PILE and
                    len(self.piles[BOTTOM_FACE_UP_PILE]) == 0
                ):
