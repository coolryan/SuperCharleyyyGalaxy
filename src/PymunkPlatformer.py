...
SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_TITLE = 800, 600, "Pymunk Platformer"

# How big are our image tiles?
SPRITE_IMAGE_SIZE = 128

# Scale sprites up or down
SPRITE_SCALING_PLAYER, SPRITE_SCALING_TILES = 0.5, 0.5

# Scaled sprite size for tiles
SPRITE_SIZE = int(SPRITE_IMAGE_SIZE * SPRITE_SCALING_PLAYER)

# Size of grid to show on screen, in number of tiles
SCREEN_GRID_WIDTH, SCREEN_GRID_HEIGHT = 25, 15
...
DEFAULT_DAMPING, PLAYER_DAMPING  = 1.0, 0.4

# Friction between objects
PLAYER_FRICTION, WALL_FRICTION, DYNAMIC_ITEM_FRICTION = 1.0, 0.7, 0.6

# Mass (defaults to 1)
PLAYER_MASS = 2.0

# Keep player from going too fast
PLAYER_MAX_HORIZONTAL_SPEED, PLAYER_MAX_VERTICAL_SPEED = 450, 1600

# Force applied while on the ground
PLAYER_MOVE_FORCE_ON_GROUND = 8000

# Force appiled when moving left/right in the air
