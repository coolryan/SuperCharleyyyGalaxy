...
class NBodyGravityWindow(arcade.Window):
    def __int__(self):
        ...
        """ 
        Create pairs of buffers for teh compute & visualization shaders.
        We will swap which buffer insatnce is the initial value and
        ...
        4f = position & size -> x, y, z, radious
        4x4 = Four floats used for calcuating velcoity. Not needed for visualization.
        4f = color -> rgba
        """
        ...
        self.vao_prevoius = self.ctx.geometry(
        ...
        # Create the complete shader program which will draw the shaders
        ...
        with its corressoing value.
        """
        self.group_x, self.group_y = 256, 1
        ...
        # Enable timings for the performace graph
        arcade.enable_timings()

        # Create a sprite list to put the performance graph into
        self.perf_graph_list = arcade.SpriteList()

        # Create the FPS performace graph
    ...
    def on_draw(self):
        ...
        """
        If you wanted, you could set input varaibles fro compute shader
        as in the lines commented out below. You would have to add or
        uncomment corresponding lines in computer_shader.glsl
        self.computer_shader["screen_size"] = self.get_size()
        self.computer_shader["frame_time] = self.frame_time
        """
        ...
        self.vao_prevoius, self.vao_current = self.vao_current, self.vao_prevoius
